...
/// struct for typed errors of method [`v1_search_post`]
...
pub async fn v1_search_post(configuration: &configuration::Configuration, content_type: Option<&str>, notion_version: Option<&str>, body: Option<&str>) -> Result<serde_json::Value, Error<V1SearchPostError>> {
